...
<body class="min-h-screen bg-gray-100 p-6">
    ...
    <div class="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow">
        ...
        <p class="mb-4">Anda login sebagai <span class="font-semibold text-green-600">Petugas Dapur</span>.</p>

        <ul class="list-disc ml-6 mb-6">
            <li><a href="{{ route('permintaan.index') }}" class="text-green-500 hover:underline">Buat Permintaan
                    Bahan</a></li>
            <li><a href="{{ route('permintaan.index') }}" class="text-green-500 hover:underline">Lihat Status
                    Permintaan</a></li>
        </ul>
